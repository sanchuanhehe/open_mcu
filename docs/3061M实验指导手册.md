...
* 下载并安装Windows版本的[HiSparkStudio 1.0.0.2]( [https：//hispark-obs.obs.cn-east-3.myhuaweicloud.com/HiSparkStudio_1.0.0.2.exe](https：//gitee.com/link?target=https%3A%2F%2Fhispark-obs.obs.cn-east-3.myhuaweicloud.com%2FHiSparkStudio_1.0.0.2.exe))

  > 本文使用的开发环境如下：
  >
  > IDE版本：HiSpark Studio （1.0.0.2），SDK版本：SolarA2 （1.0.0.2）
  >
...
- 支持API版本、SDK版本：SolarA2 1.0.1.2

- 支持IDE版本号：HiSpark Studio 1.0.0.2
